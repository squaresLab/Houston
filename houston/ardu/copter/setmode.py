...
class SetModeSchema(ActionSchema):
    ...
    def __init__(self):
        ...
        branches = [
            SetModeGuided(self, parameters),
            SetModeLoiter(self, parameters),
            SetModeRTL(self, parameters),
            SetModeLand(self, parameters),
...
class SetModeLand(Branch):
    def __init__(self, schema, parameters):
        specification = Specification(parameters,
            ...
            """,
            None)
        super().__init__('land', schema, specification)
...
class SetModeGuided(Branch):
    def __init__(self, schema, parameters):
        specification = Specification(parameters,
            ...
            """,
            None)
        super().__init__('guided', schema, specification)
...
class SetModeLoiter(Branch):
    def __init__(self, schema, parameters):
        specification = Specification(parameters,
            ...
            """,
            None)
        super().__init__('loiter', schema, specification)
...
class SetModeRTL(Branch):
    def __init__(self, schema, parameters):
        specification = Specification(parameters,
            ...
            """,
            None)
        super().__init__('rtl', schema, specification)
