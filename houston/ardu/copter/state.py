...
class State(BaseState):
    ...
    vx = var(float, lambda c: c.conn.velocity[0], noise=0.15)
    vy = var(float, lambda c: c.conn.velocity[1], noise=0.15)
    vz = var(float, lambda c: c.conn.velocity[2], noise=0.15)
    ...
    airspeed = var(float, lambda c: c.conn.airspeed, noise=0.15)
    groundspeed = var(float, lambda c: c.conn.groundspeed, noise=0.15)
